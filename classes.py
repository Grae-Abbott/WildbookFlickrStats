class Album:
    def __init__(self, set_id, url = "", user_id = "", name = "", size = -1, species_count = {}, species_ratio = -1, species_ofInterest = "", photo_list = [], time_range_posted = -1.0, time_range_taken = -1.0):
